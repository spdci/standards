...
$(function () {
    ...
    $.getJSON('./assets/example_files/'+getFolder+'/usecaselist.json', function (data) {
        ...
        $.each(data, function (index, val) {
            ...
            $.getJSON('./assets/example_files/'+ getFolder + '/' + usecaseid + "req.json", function (data) {
                renderJson('req' + usecaseid, data)
            });
            $.getJSON('./assets/example_files/'+ getFolder+ "/" + usecaseid + "res.json", function (data) {
